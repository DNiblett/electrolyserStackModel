...
N_stacks = 10;                      % Number of stacks
Power = 1e6;                       % Operating power if constant current
...
sim.endTime = 60*60*10;           % Limit for the simulation time.
...
if strcmpi(sim.readExternalPower,'on')
    ...
    powerData_Power = double((externalData.power_MW)).*1e6;  % [W]
...
stack.BOPutilisation = 0.*stack.ratedCapacity; % fraction of rated power used by stack
